export default function Menu() {
  return (
    <>
      ...
      <header>
        <nav className="bg-gray-100 border-gray-200 px-3 lg:px-6 py-2.5 dark:bg-gray-800">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="" className="flex items-center">
              {/* <img
                src="https://smartowl.com.br/assets/logo_azul-7732625b.png"
            ...
            <div className="flex items-center lg:order-2">
              {/* <a
                href="#"
                className="text-white bg-blue-900 font-bold text-lg dark:text-white rounded-lg  px-4 lg:px-5 py-2 lg:py-2.5 mr-2 "
              >
                Entrar
              </a> */}
              {/* <a
